<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="yenikayit.aspx.cs" Inherits="Deneme.yenikayit" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table style="border: 1px solid black">
                ...
                <tr>
                    <td colspan="2">
                        <asp:Button ID="Button1" runat="server" class="btn btn-info" Text="KAYDET" OnClick="Button1_Click" Width="200" Style="background-color: aqua" Font-Bold="True" />
                    </td>
                </tr>
            </table>
        </div>
